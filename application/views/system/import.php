...
<div class="row featurette">
    <div class="col-md-3">
        <h2 class="featurette-heading">Ali 订单HTML <small>文件名必须非中文</small></h2>
        <?php if(isset($error)) {echo $error;}?>
        <?php echo form_open_multipart('system/do_upload_order_html');?>
        ...
        <?php if(isset($fn)) {
            echo '<h2 class="featurette-heading">订单: '.$fn.' 已提交</h2>';
            echo '<a class="btn btn-primary" onclick="jump(\''.base_url().'index.php/system/socket/'.$fn.'\')">激活</a>';
        }?>
    </div>
</div>
