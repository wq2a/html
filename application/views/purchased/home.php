...
<a href="#" onclick="jump('<?php echo base_url()?>index.php/purchased/allorder')" value="搜索" class="list-group-item <?php if(isset($pageTag)&&$pageTag=='all')echo ' active';?>">所 有 订 单<span class="badge"><?php echo isset($all_rows)?$all_rows:'';?></span></a>
<a href="#" onclick="jump('<?php echo base_url()?>index.php/purchased/notcheckedorder')" value="搜索" class="list-group-item <?php if(isset($pageTag)&&$pageTag=='notchecked')echo ' active';?>">未 核 对 订 单<span class="badge badge-danger"><?php echo isset($notchecked_rows)?$notchecked_rows:'';?></span></a>
...
<hr>
<div class="list-group">
<a href="#" onclick="jump('<?php echo base_url()?>index.php/purchased/allsuppliers')" value="搜索" class="list-group-item <?php if(isset($pageTag)&&$pageTag=='allsuppliers')echo ' active';?>">供 应 商</a>
<a href="#" onclick="jump('<?php echo base_url()?>index.php/purchased/calandar')" value="搜索" class="list-group-item <?php if(isset($pageTag)&&$pageTag=='calandar')echo ' active';?>">采 购 日 程</a>
</div>
</div>
